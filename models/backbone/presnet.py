...
# ------------------------------------------------------------------------
# Modified from RTDETR (https://github.com/lyuwenyu/RT-DETR/blob/main/rtdetr_pytorch/src/nn/backbone/presnet.py)
...
class PResNet(nn.Module):
    ...
    def __init__(
        ...
        # assert pretrained_backbone is not None, "Download pretrained_backbone first."
        # checkpoint = torch.load(pretrained_backbone, map_location="cpu")
        # self.load_state_dict(checkpoint)
        # print(f'Load PResNet{depth} state_dict')
        self._out_feature_channels = sum([_out_channels[idx] for idx in return_idx])
        self._out_features = [True]
